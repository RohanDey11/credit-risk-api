...
# CORRECT IMPORTS - matches your actual files
...
<div class="container">
  ...
  <div class="grid">
    <div class="card">
      ...
      <form id="riskForm">
        <div class="form-group"><label>Age</label><input type="number" name="person_age" value="32" min="18" max="100" required><div class="hint">18-100, 15 returns 422</div></div>
...
# FIX 405: Accept GET, HEAD, POST, OPTIONS so UptimeRobot never gets 405
...
async def predict(request: CreditRiskInput):
    ...
    try:
        ...
        # preprocess_input takes only 1 arg in your file - it loads columns internally
